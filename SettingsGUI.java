...
public class SettingsGUI extends JFrame implements ActionListener
{
	...
	public SettingsGUI(String username,String password)
	{
		super("Changing Password : "+username);
		try
		{
			Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
			c = DriverManager.getConnection("jdbc:odbc:VAULT");
			s = c.createStatement();
		}
		catch(Exception e)
		{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			hide();
			VaultLogin login = new VaultLogin();
			return;
		}
